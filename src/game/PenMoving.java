/**
 * Tower Defense -- creates our pen moving tower object
 * 
...
public class PenMoving extends Towers {
	 ...
	 * @param state
	 */
	public PenMoving(int x, int y, GameState state, GameControl control) {
		super(x, y, state);
	...
	public void update(double elapsedTime) {
		...
		if (state.getMouseClicked() && x < 630) {
			...
			state.addAnimatable(new Pen(x, y, state)); // creates our newly placed tower.
